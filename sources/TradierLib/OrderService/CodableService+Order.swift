// Overview: TradierBrokerageOrderModel placement for Tradier.CodableService.
...
extension Tradier.CodableService {
  ...
  ///   - duration: TradierBrokerageOrderModel duration (e.g. day, gtc).
  ...
  public func placeOrder(
    ...
    price: Double,
  ) async throws -> Tradier.TradierBrokerageOrderResultModel {
  ...
  /// Mirrors `placeOrder` parameters and returns an `TradierBrokerageOrderResultModel` with broker status.
